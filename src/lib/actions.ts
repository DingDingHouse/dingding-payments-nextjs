...
export async function getRoles(): Promise<
  ActionResponse<RolesResponse["data"]>
> {
  try {
    const accessToken = await getCookie("accessToken");
...
export async function getDescendants(
  ...
  try {
    ...
    const url = new URL(
      `${config.server}/api/users/me/descendants?${params.toString()}`
    );
...
export async function updateUserPermissions(
  ...
  try {
    ...
    const response = await fetch(
      `${config.server}/api/users/${userId}/permissions`,
      {
        method: "PATCH",
        body: JSON.stringify(data),
        headers: {
...
export async function getReport(dateRange?: { from?: string; to?: string }) {
  try {
    ...
    const response = await fetch(
      `${config.server}/api/users/me/report?${params.toString()}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${accessToken}`,
...
export async function getUserReport(
  ...
  try {
    ...
    const response = await fetch(
      `${config.server}/api/users/${userId}/report?${params.toString()}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${accessToken}`,
...
export async function getUserDescendants(
  ...
  try {
    ...
    const response = await fetch(
      `${config.server}/api/users/${id}/descendants?${params.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${accessToken}`,
          "Content-Type": "application/json",
...
export async function getAllGames(
  ...
  try {
    ...
    const response = await fetch(
      `${config.server}/api/games?${params.toString()}`,
      {
        headers: {
          Authorization: `Bearer ${accessToken}`,
          "Content-Type": "application/json",
