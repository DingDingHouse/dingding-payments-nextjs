...
import { ArrowDown, ArrowUp, MoreHorizontal, Pencil, ShieldCheck, Trash, User as UserIcon } from "lucide-react"
    ...
    return <div className="space-y-6">
        <div className="mb-6 overflow-x-auto">
            <div className="flex gap-2 min-w-max">
                ...
                <Button
                    asChild
                    variant={view === 'created' ? 'default' : 'outline'}
                >
                    <Link href="?view=created">Created by me</Link>
                </Button>
                <Button
                    asChild
                    variant={view === 'others' ? 'default' : 'outline'}
                >
