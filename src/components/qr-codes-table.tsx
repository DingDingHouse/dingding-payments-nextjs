...
import { deleteQRCode, updateQRCode } from "@/app/(dashboard)/wallets/actions";
      ...
      cell: ({ row }) => (
        <div className="flex items-center gap-2">
          <div className="relative h-16 w-16 shrink-0">
            <div className="absolute inset-0 rounded-md bg-white dark:bg-white">
              {" "}
